...
import static com.ap.managers.ClockManager.totalSecondsFrom;
...
public class ScreenBrightnessSystem extends EntitySystem {
    ...
    public void update(float deltaTime) {
        float darknessProgress = MathUtils.clamp(totalSecondsFrom(timeSystem.getTotalSeconds(), darknessBegin)
