...
public class RenderSystem extends SortedIteratingSystem {
    ...
    public RenderSystem(Batch batch, Viewport viewport, Camera camera, AssetService assetService) {
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        if(texture == null) {
             texture = assetService.get(graphic.getAtlas()).findRegion(graphic.getAtlasKey());
        }
