...
public class TransitionManager {
    ...
    private Consumer<Integer> mapLoader;
    ...
    public TransitionManager(GdxGame game, Consumer<Integer> mapLoader) {
        this.game = game;
    ...
    public void initTransition(int newMap) {
        this.newMap = newMap;
        this.isTransitioning = true;
        expanding = true;
        timer = 0f;
