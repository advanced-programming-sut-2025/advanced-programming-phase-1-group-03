...
public enum ForagingMineralTypes {
    ...
    // Omni
    Earth_Crystal("*", Colors.fg(251), "", "EarthCrystal", LevelName.iron, "A resinous substance found near the surface.", 50, 5),

    FrozenTear("*", Colors.fg(251), "", "FrozenTear", LevelName.iron, "A crystal fabled to be the frozen tears of a yeti.", 75, 5),

    Fire_Quartz("*", Colors.fg(251), "", "FireQuartz", LevelName.iron,"A glowing red crystal commonly found near hot lava.", 100, 5),
    ...
    Prismatic_Shard("*", Colors.fg(251), "", "PrismaticShard", LevelName.iron,"A very rare and powerful substance with unknown origins.", 2000, 5),
    Copper_Ore("C", Colors.fg(251), "", "Copper Ore", LevelName.normal,"A common ore that can be smelted into bars.", 75, 10),
    Iron_Ore("i", Colors.fg(251), "", "Iron", LevelName.copper, "A fairly common ore that can be smelted into bars.", 150, 10),
    Gold_Ore("G", Colors.fg(251), "", "Gold", LevelName.iron, "A precious ore that can be smelted into bars.", 400, 10),
    Iridium_Ore("I", Colors.fg(251), "", "Iridium", LevelName.golden, "An exotic ore with many curious properties. Can be smelted into bars.", 100, 10),
