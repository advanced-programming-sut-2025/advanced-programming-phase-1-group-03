...
public enum CarpenterShopProducts {
    ...
    Barn("Barn", "Houses 4 barn-dwelling animals.", 6000, 350, 150, 7, 4, 1, new AnimalHouse(7, 4, BuildingTypes.Barn, new Coordinate(0, 0))),
    BigBarn("Big Barn", "Houses 8 barn-dwelling animals. Unlocks goats.", 12000, 450, 200, 7, 4, 1, new AnimalHouse(7, 4, BuildingTypes.BigBarn, new Coordinate(0, 0))),
    DeluxeBarn("Deluxe Barn", "Houses 12 barn-dwelling animals. Unlocks sheep and pigs.", 25000, 550, 300, 7, 4, 1, new AnimalHouse(7, 4, BuildingTypes.DeluxeBarn, new Coordinate(0, 0))),
    Coop("Coop", "Houses 4 coop-dwelling animals.", 4000, 300, 100, 6, 3, 1, new AnimalHouse(6, 3, BuildingTypes.Coop, new Coordinate(0, 0))),
    BigCoop("Big Coop", "Houses 8 coop-dwelling animals. Unlocks ducks.", 10000, 400, 150, 6, 3, 1, new AnimalHouse(6, 3, BuildingTypes.BigCoop, new Coordinate(0, 0))),
    DeluxeCoop("Deluxe Coop", "Houses 12 coop-dwelling animals. Unlocks rabbits.", 20000, 500, 200, 6, 3, 1, new AnimalHouse(6, 3, BuildingTypes.DeluxeCoop, new Coordinate(0, 0))),
