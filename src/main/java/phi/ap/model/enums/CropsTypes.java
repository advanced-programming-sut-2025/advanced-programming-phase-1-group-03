...
public enum CropsTypes {
    BlueJazz("BlueJazz", SeedTypes.JazzSeeds, new ArrayList<>(Arrays.asList(1, 2, 2, 2)), 7, true, 100000000, 50, new Eatable(45), 45, new ArrayList<>(List.of(Seasons.Spring)), false, 1),
    ...
    CoffeeBean("CoffeeBean", SeedTypes.CoffeeBean, new ArrayList<>(Arrays.asList(1, 2, 2, 3, 2)), 10, false, 2, 15, null, 0, new ArrayList<>(List.of(Seasons.Spring, Seasons.Summer)), false, 1),
    ...
    GreenBean("GreenBean", SeedTypes.BeanStarter, new ArrayList<>(Arrays.asList(1, 1, 1, 3, 4)), 10, false, 3, 40, new Eatable(25), 25, new ArrayList<>(List.of(Seasons.Spring)), false, 1),
    ...
    UnmilledRice("UnmilledRice", SeedTypes.RiceShoot, new ArrayList<>(Arrays.asList(1, 2, 2, 3)), 8, true, 100000000, 30, new Eatable(3), 3, new ArrayList<>(List.of(Seasons.Spring)), false, 1),
    ...
    Corn("Corn", SeedTypes.CornSeeds, new ArrayList<>(Arrays.asList(2, 3, 3, 3, 3)), 14, false, 4, 50, new Eatable(25), 25, new ArrayList<>(List.of(Seasons.Summer, Seasons.Fall)), false, 1),
    ...
    HotPepper("HotPepper", SeedTypes.PepperSeeds, new ArrayList<>(Arrays.asList(1, 1, 1, 3, 1)), 5, false, 3, 40, new Eatable(13), 13, new ArrayList<>(List.of(Seasons.Summer)), false, 1),
    ...
    RedCabbage("RedCabbage", SeedTypes.RedCabbageSeeds, new ArrayList<>(Arrays.asList(2, 1, 2, 2, 2)), 9, true, 100000000, 260, new Eatable(75), 75, new ArrayList<>(List.of(Seasons.Summer)), false, 1),
    ...
    SummerSpangle("SummerSpangle", SeedTypes.SpangleSeeds, new ArrayList<>(Arrays.asList(1, 2, 3, 1)), 8, true, 100000000, 90, new Eatable(45), 45, new ArrayList<>(List.of(Seasons.Summer)), false, 1),
    SummerSquash("SummerSquash", SeedTypes.SummerSquashSeeds, new ArrayList<>(Arrays.asList(1, 1, 1, 2, 1)), 6, false, 3, 45, new Eatable(63), 63, new ArrayList<>(List.of(Seasons.Summer)), false, 1),
    Sunflower("Sunflower", SeedTypes.SunflowerSeeds, new ArrayList<>(Arrays.asList(1, 2, 3, 2)), 8, true, 100000000, 80, new Eatable(45), 45, new ArrayList<>(List.of(Seasons.Summer, Seasons.Fall)), false, 1),
    ...
    Wheat("Wheat", SeedTypes.WheatSeeds, new ArrayList<>(Arrays.asList(1, 1, 1, 1)), 4, true, 100000000, 25, null, 0, new ArrayList<>(List.of(Seasons.Summer, Seasons.Fall)), false, 1),
    ...
    BokChoy("BokChoy", SeedTypes.BokChoySeeds, new ArrayList<>(Arrays.asList(1, 1, 1, 1)), 4, true, 100000000, 80, new Eatable(25), 25,  new ArrayList<>(List.of(Seasons.Fall)), false, 1),
    ...
    FairyRose("FairyRose", SeedTypes.FairySeeds, new ArrayList<>(Arrays.asList(1, 4, 4, 3)), 12, true, 100000000, 290, new Eatable(45), 45, new ArrayList<>(List.of(Seasons.Fall)), false, 1),
    ...
    SweetGemBarry("SweetGemBerry", SeedTypes.RareSeed, new ArrayList<>(Arrays.asList(2, 4, 6, 6, 6)), 24, true, 100000000, 3000, null, 0, new ArrayList<>(List.of(Seasons.Fall)), false, 1),
    ...
    AncientFruit("AncientFruit", SeedTypes.AncientSeeds, new ArrayList<>(Arrays.asList(2, 7, 7, 7, 5)), 28, false, 7, 550, null, 0, new ArrayList<>(List.of(Seasons.Spring, Seasons.Summer, Seasons.Fall)), false, 1);
