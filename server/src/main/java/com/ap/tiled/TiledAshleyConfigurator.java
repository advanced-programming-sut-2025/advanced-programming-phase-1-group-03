...
public class TiledAshleyConfigurator {
   ...
   //     TiledPhysic.createBodyForTile(x, y, tile, world, true);
    ...
    private static void addEntityGraphic(Entity entity, TiledMapTile tile) {
        String atlasAssetStr = tile.getProperties().get("atlasAsset", "MapObjects", String.class);
        AtlasAsset atlas = AtlasAsset.valueOf(atlasAssetStr);
        FileTextureData textureData = (FileTextureData) tile.getTextureRegion().getTexture().getTextureData();
        String atlasKey = textureData.getFileHandle().nameWithoutExtension();
        entity.add(new Graphic(atlas, atlasKey));
    }
