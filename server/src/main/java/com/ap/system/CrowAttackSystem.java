...
//            if (Growable.mapper.get(entity).getCurrentStage() == 0) continue;
        ...
        System.out.println("attackables: " + attackables.size);

        int newCrowNumber = Math.min(attackables.size / 1, 4);
...
//            if (Helper.random(1, 2) != 1) continue;
            ...
            System.out.println("crow added");
            Helper.addEntity(EntityFactory.instance.CreateCrowEntity(purpose), engine);
